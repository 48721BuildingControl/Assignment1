...
def mech_sys_overview(request):
    return render(request, 'mech-sys-overview.html')

def mech_sys_nv(request):
    return render(request, 'mech-sys-nv.html')

def mech_sys_geo(request):
    return render(request, 'mech-sys-geo.html')

def mech_sys_ufds(request):
    return render(request, 'mech-sys-ufds.html')

def mech_sys_tcers(request):
    return render(request, 'mech-sys-tcers.html')

def mech_sys_location(request):
    return render(request, 'mech-sys-location.html')

def dynamic_data(request):
    return render(request, 'dynamic-data.html')

def lighting_sys_overview(request):
    return render(request, 'lighting-sys-overview.html')

def lighting_sys_dl(request):
    return render(request, 'lighting-sys-daylighting.html')

def lighting_sys_al(request):
    return render(request, 'lighting-sys-artificial.html')

def lighting_sys_location(request):
    return render(request, 'lighting-sys-location.html')

def sys_diagram_mech(request):
    return render(request, 'sys-diagram-mech.html')

def sys_diagram_lighting(request):
    return render(request, 'sys-diagram-lighting.html')
